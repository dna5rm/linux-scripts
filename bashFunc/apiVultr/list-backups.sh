...
function list-backups ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Get information about Backups in your account.
	Ref: /backups
	---
	...
	instance_id     query   false   false    the backup list by [Instance id](#operation/list-instances).
	...
	EOF
        ...
        curl --silent --location --request GET --url "${VULTR_API_URI}/backups" \
