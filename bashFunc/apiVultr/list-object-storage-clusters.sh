...
function list-object-storage-clusters ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Get a list of all Object Storage Clusters.
	Ref: /object-storage/clusters
	---
	...
	EOF
        ...
        curl --silent --location --request GET --url "${VULTR_API_URI}/object-storage/clusters" \
