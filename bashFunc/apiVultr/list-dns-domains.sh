...
function list-dns-domains ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - List all DNS Domains in your account.
	Ref: /domains
	---
	...
	EOF
        ...
        curl --silent --location --request GET --url "${VULTR_API_URI}/domains" \
