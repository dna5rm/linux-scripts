...
function list-object-storages ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Get a list of all Object Storage in your account.
	Ref: /object-storage
	---
	...
	EOF
        ...
        curl --silent --location --request GET --url "${VULTR_API_URI}/object-storage" \
