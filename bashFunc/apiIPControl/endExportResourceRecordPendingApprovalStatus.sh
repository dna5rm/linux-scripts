...
function endExportResourceRecordPendingApprovalStatus ()
{
	...
	EOF
	 ...
	 --data-urlencode "ipAddress=${1}" --url "${ipcontrol_uri}/Exports/endExportResourceRecordPendingApprovalStatus"
   fi
}
