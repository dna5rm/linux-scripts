## Issue Dynamic DNS Configuration Changed Resource Records Task
...
function dnsDDNSChangedRRs ()
{
	...
	EOF
	 ...
	 --data-urlencode "ipAddress=${1}" --url "${ipcontrol_uri}/TaskInvocation/dnsDDNSChangedRRs"
   fi
}
