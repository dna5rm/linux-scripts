## Issue Global Synchronization Task for Network Service
...
function globalNetServiceSync ()
{
	...
	EOF
	 ...
	 --data-urlencode "ipAddress=${1}" --url "${ipcontrol_uri}/TaskInvocation/globalNetServiceSync"
   fi
}
