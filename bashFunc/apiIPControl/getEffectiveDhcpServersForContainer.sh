## Get a list of accessible DHCP Servers
...
function getEffectiveDhcpServersForContainer ()
{
	...
	EOF
	 ...
	 --data-urlencode "ipAddress=${1}" --url "${ipcontrol_uri}/Gets/getEffectiveDhcpServersForContainer"
   fi
}
