## Delete a network element interface
# The deleteNetElementInterface operation enables you to delete a network element interface from IPControl.
#
# Ref: https://${ipcontrol_uri}/inc-rest/api/docs/index.html

function deleteNetElementInterface ()
{
	...
	EOF
	 ...
	 --data-urlencode "ipAddress=${1}" --url "${ipcontrol_uri}/Deletes/deleteNetElementInterface"
   fi
}
