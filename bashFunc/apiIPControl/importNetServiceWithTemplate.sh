## Import a network service using a template
...
function importNetServiceWithTemplate ()
{
	...
	EOF
	 ...
	 --data-urlencode "ipAddress=${1}" --url "${ipcontrol_uri}/Imports/importNetServiceWithTemplate"
   fi
}
