...
function updateNetworkFirmwareUpgradesStagedStages ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Assign Staged Upgrade Group order in the sequence.
	Ref: https://developer.cisco.com/meraki/api-v1/#!update-network-firmware-upgrades-staged-stages
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request PUT --url "${meraki_uri}/networks/${1}/firmwareUpgrades/staged/stages" \
