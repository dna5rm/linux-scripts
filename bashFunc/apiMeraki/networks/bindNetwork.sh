...
function bindNetwork ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Bind a network to a template.
	Ref: https://developer.cisco.com/meraki/api-v1/#!bind-network
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request POST --url "${meraki_uri}/networks/${1}/bind" \
