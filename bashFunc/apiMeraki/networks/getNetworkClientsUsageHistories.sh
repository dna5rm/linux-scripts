...
function getNetworkClientsUsageHistories ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Return the usage histories for clients
	Ref: https://developer.cisco.com/meraki/api-v1/#!get-network-clients-usage-histories
	---
	...
	EOF
         ...
         curl --silent --location \
          --request GET --url "${meraki_uri}/networks/${1}/clients/usageHistories" \
