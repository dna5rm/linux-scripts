...
function deleteDeviceSwitchRoutingInterface ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Delete a layer 3 interface from the switch
	Ref: https://developer.cisco.com/meraki/api-v1/#!delete-device-switch-routing-interface
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request DELETE --url "${meraki_uri}/devices/${1}/switch/routing/interfaces/${2}" \
