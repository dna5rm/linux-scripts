...
function getNetworkSwitchStackRoutingInterfaces ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - List layer 3 interfaces for a switch stack
	Ref: https://developer.cisco.com/meraki/api-v1/#!get-network-switch-stack-routing-interfaces
	---
	...
	EOF
         ...
         curl --silent --location \
          --request GET --url "${meraki_uri}/networks/${1}/switch/stacks/${2}/routing/interfaces" \
