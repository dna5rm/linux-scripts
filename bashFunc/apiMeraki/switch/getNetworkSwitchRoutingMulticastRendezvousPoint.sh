...
function getNetworkSwitchRoutingMulticastRendezvousPoint ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Return a multicast rendezvous point
	Ref: https://developer.cisco.com/meraki/api-v1/#!get-network-switch-routing-multicast-rendezvous-point
	---
	...
	EOF
         ...
         curl --silent --location \
          --request GET --url "${meraki_uri}/networks/${1}/switch/routing/multicast/rendezvousPoints/${2}" \
