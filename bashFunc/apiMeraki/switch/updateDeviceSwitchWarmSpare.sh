...
function updateDeviceSwitchWarmSpare ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Update warm spare configuration for a switch
	Ref: https://developer.cisco.com/meraki/api-v1/#!update-device-switch-warm-spare
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request PUT --url "${meraki_uri}/devices/${1}/switch/warmSpare" \
