...
function updateNetworkSmTargetGroup ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Update a target group
	Ref: https://developer.cisco.com/meraki/api-v1/#!update-network-sm-target-group
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request PUT --url "${meraki_uri}/networks/${1}/sm/targetGroups/${2}" \
