...
function getNetworkSmDeviceDeviceCommandLogs ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Return historical records of commands sent to Systems Manager devices
	Ref: https://developer.cisco.com/meraki/api-v1/#!get-network-sm-device-device-command-logs
	---
	...
	EOF
         ...
         curl --silent --location \
          --request GET --url "${meraki_uri}/networks/${1}/sm/devices/${2}/deviceCommandLogs" \
