...
function updateOrganizationSamlIdp ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Update a SAML IdP in your organization
	Ref: https://developer.cisco.com/meraki/api-v1/#!update-organization-saml-idp
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request PUT --url "${meraki_uri}/organizations/${1}/saml/idps/${2}" \
