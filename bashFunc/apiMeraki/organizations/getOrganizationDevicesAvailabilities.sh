...
function getOrganizationDevicesAvailabilities ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - List the availability information for devices in an organization
	Ref: https://developer.cisco.com/meraki/api-v1/#!get-organization-devices-availabilities
	---
	...
	EOF
         ...
         curl --silent --location \
          --request GET --url "${meraki_uri}/organizations/${1}/devices/availabilities" \
