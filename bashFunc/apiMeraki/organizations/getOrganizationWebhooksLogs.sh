...
function getOrganizationWebhooksLogs ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Return the log of webhook POSTs sent
	Ref: https://developer.cisco.com/meraki/api-v1/#!get-organization-webhooks-logs
	---
	...
	EOF
         ...
         curl --silent --location \
          --request GET --url "${meraki_uri}/organizations/${1}/webhooks/logs" \
