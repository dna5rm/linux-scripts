...
function claimIntoOrganization ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Claim a list of devices, licenses, and/or orders into an organization
	Ref: https://developer.cisco.com/meraki/api-v1/#!claim-into-organization
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request POST --url "${meraki_uri}/organizations/${1}/claim" \
