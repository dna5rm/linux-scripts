...
function updateOrganizationApplianceSecurityIntrusion ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Sets supported intrusion settings for an organization
	Ref: https://developer.cisco.com/meraki/api-v1/#!update-organization-appliance-security-intrusion
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request PUT --url "${meraki_uri}/organizations/${1}/appliance/security/intrusion" \
