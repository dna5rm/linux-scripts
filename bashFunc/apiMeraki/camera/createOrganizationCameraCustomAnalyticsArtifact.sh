...
function createOrganizationCameraCustomAnalyticsArtifact ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Create custom analytics artifact
	Ref: https://developer.cisco.com/meraki/api-v1/#!create-organization-camera-custom-analytics-artifact
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request POST --url "${meraki_uri}/organizations/${1}/camera/customAnalytics/artifacts" \
