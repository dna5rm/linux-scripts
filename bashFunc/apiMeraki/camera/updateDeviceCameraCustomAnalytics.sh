...
function updateDeviceCameraCustomAnalytics ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Update custom analytics settings for a camera
	Ref: https://developer.cisco.com/meraki/api-v1/#!update-device-camera-custom-analytics
	---
	...
	EOF
        ...
        echo curl --silent --output /dev/null --write-out "%{http_code}\n" --location \
          --request PUT --url "${meraki_uri}/devices/${1}/camera/customAnalytics" \
