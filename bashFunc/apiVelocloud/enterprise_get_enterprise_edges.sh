...
# Gets all Edges associated with the specified enterprise, including optional site, link, and configuration details.
#
...
function enterprise_get_enterprise_edges ()
{
	...
	curlOutput="$(mktemp)"
	http_code=`curl --silent --location --request POST --url "${velocloud_uri}/configuration/getConfigurationModules" \
