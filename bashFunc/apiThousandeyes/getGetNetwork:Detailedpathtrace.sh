...
function GetNetwork:Detailedpathtrace ()
{
	...
	Ref: /endpoint-data/tests/net/path-vis/{testId}/{agentId}/{roundId}.json
	---
	...
	EOF
        ...
        curl --silent --insecure --location --request GET --url "${thousandeyes_uri}/endpoint-data/tests/net/path-vis/${1}/${2}/${3}" \
