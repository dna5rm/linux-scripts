...
# /api/sdwan/v2/enterprises/{enterpriseLogicalId}/applications

function getEnterpriseApplications ()
{
	...
	Ref: /api/sdwan/v2/enterprises/{enterpriseLogicalId}/applications
	---
	...
	EOF
        ...
        url=( "${vco_uri%/*/*}/api/sdwan/v2/enterprises/${1}/applications" )
