...
# /api/sdwan/v2/applicationMaps/{logicalId}/applicationClasses

function getApplicationMapApplicationClasses ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Fetch application map classes   
	Ref: /api/sdwan/v2/applicationMaps/{logicalId}/applicationClasses
	---
	...
	EOF
        ...
        url=( "${vco_uri%/*/*}/api/sdwan/v2/applicationMaps/${1}/applicationClasses" )
