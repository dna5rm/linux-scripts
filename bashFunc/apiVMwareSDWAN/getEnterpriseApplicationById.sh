...
# /api/sdwan/v2/enterprises/{enterpriseLogicalId}/applications/{appId}

function getEnterpriseApplicationById ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Fetch enterprise applications   
	Ref: /api/sdwan/v2/enterprises/{enterpriseLogicalId}/applications/{appId}
	---
	...
	EOF
        ...
        url=( "${vco_uri%/*/*}/api/sdwan/v2/enterprises/${1}/applications/${2}" )
