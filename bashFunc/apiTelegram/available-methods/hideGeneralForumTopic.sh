...
function hideGeneralForumTopic ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Use this method to hide the 'General' topic in a forum supergroup chat.
	...
	must have the *can_manage_topics* administrator rights. The topic will
	...
	EOF
        ...
        curl --silent --location \
          --request POST --url "https://api.telegram.org/bot${TELEGRAM_TOKEN}/hideGeneralForumTopic" \
