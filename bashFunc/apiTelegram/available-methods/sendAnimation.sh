## sendanimation # Use this method to send animation files (GIF or H.
...
function sendAnimation ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Use this method to send animation files (GIF or H.
	...
	EOF
        ...
        curl --silent --location \
          --request POST --url "https://api.telegram.org/bot${TELEGRAM_TOKEN}/sendAnimation" \
