...
function sendAudio ()
{
	...
	cat <<-EOF
	$(basename "${0}" 2> /dev/null):${FUNCNAME[0]} - Use this method to send audio files, if you want Telegram clients to display them in the music player.
	...
	EOF
        ...
        curl --silent --location \
          --request POST --url "https://api.telegram.org/bot${TELEGRAM_TOKEN}/sendAudio" \
