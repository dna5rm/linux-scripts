...
function delete_composite_roles_by_operator ()
{
	...
	Ref: /compositeRole/deleteByOperator
	---
	...
	EOF
        ...
        curl --silent --insecure --location --request POST --url "${vco_uri}/compositeRole/deleteByOperator" \
