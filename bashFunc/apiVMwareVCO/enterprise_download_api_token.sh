...
function enterprise_download_api_token ()
{
	...
	Ref: /enterprise/downloadApiToken
	---
	...
	EOF
        ...
        curl --silent --insecure --location --request POST --url "${vco_uri}/enterprise/downloadApiToken" \
