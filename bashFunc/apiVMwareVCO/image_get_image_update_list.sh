...
function image_get_image_update_list ()
{
	...
	Ref: /softwareUpdate/getSoftwareUpdatesList
	---
	...
	EOF
        ...
        curl --silent --insecure --location --request POST --url "${vco_uri}/softwareUpdate/getSoftwareUpdatesList" \
