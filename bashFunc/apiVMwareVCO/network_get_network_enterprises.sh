...
function network_get_network_enterprises ()
{
	...
	Ref: /network/getNetworkEnterprises
	---
	...
	EOF
        ...
        curl --silent --insecure --location --request POST --url "${vco_uri}/network/getNetworkEnterprises" \
