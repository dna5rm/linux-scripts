...
function sshConfig_get_enterprise_user_ssh_key ()
{
	...
	Ref: /sshConfig/getEnterpriseUserSSHKey
	---
	...
	EOF
        ...
        curl --silent --insecure --location --request POST --url "${vco_uri}/sshConfig/getEnterpriseUserSSHKey" \
