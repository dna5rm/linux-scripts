...
function network_remove_operator_config_assoc_from_all_enterprises ()
{
	...
	EOF
        ...
        curl --silent --insecure --location --request POST --url "${vco_uri}/configuration/removeOperatorConfigurationAssocFromEnterprises" \
