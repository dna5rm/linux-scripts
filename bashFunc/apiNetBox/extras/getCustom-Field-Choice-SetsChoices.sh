## getCustom-Field-Choice-SetsChoices # null
# /api/extras/custom-field-choice-sets/{id}/choices/

function getCustom-Field-Choice-SetsChoices ()
{
	...
	Ref: /api/extras/custom-field-choice-sets/{id}/choices/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request GET --url "${netbox_api}/api/extras/custom-field-choice-sets/${1}/choices" \
