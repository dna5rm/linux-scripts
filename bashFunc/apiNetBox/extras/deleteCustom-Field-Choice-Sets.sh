## deleteCustom-Field-Choice-Sets # null
# /api/extras/custom-field-choice-sets/{id}/

function deleteCustom-Field-Choice-Sets ()
{
	...
	Ref: /api/extras/custom-field-choice-sets/{id}/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request DELETE --url "${netbox_api}/api/extras/custom-field-choice-sets/${1}" \
