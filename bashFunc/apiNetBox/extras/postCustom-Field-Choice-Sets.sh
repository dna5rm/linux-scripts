## postCustom-Field-Choice-Sets # null
# /api/extras/custom-field-choice-sets/

function postCustom-Field-Choice-Sets ()
{
	...
	Ref: /api/extras/custom-field-choice-sets/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request POST --url "${netbox_api}/api/extras/custom-field-choice-sets" \
