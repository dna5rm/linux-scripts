## postModule-Bay-Templates # null
# /api/dcim/module-bay-templates/

function postModule-Bay-Templates ()
{
	...
	Ref: /api/dcim/module-bay-templates/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request POST --url "${netbox_api}/api/dcim/module-bay-templates" \
