## deleteModule-Bay-Templates # null
# /api/dcim/module-bay-templates/{id}/

function deleteModule-Bay-Templates ()
{
	...
	Ref: /api/dcim/module-bay-templates/{id}/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request DELETE --url "${netbox_api}/api/dcim/module-bay-templates/${1}" \
