## deleteFhrp-Group-Assignments # null
# /api/ipam/fhrp-group-assignments/{id}/

function deleteFhrp-Group-Assignments ()
{
	...
	Ref: /api/ipam/fhrp-group-assignments/{id}/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request DELETE --url "${netbox_api}/api/ipam/fhrp-group-assignments/${1}" \
