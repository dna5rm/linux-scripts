## deleteService-Templates # null
# /api/ipam/service-templates/{id}/

function deleteService-Templates ()
{
	...
	Ref: /api/ipam/service-templates/{id}/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request DELETE --url "${netbox_api}/api/ipam/service-templates/${1}" \
