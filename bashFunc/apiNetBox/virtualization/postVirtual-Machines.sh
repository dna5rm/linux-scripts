## postVirtual-Machines # null
# /api/virtualization/virtual-machines/

function postVirtual-Machines ()
{
	...
	Ref: /api/virtualization/virtual-machines/
	---
	...
	EOF
        ...
        response=$(curl --silent --insecure --location --write-out "%{http_code}" \
          --request POST --url "${netbox_api}/api/virtualization/virtual-machines" \
